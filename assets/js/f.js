    ...
    function(t) {
        ...
        function E(t, e) {
            var n = e.fetch,
                o = e.XMLHttpRequest,
                r = (e.token, t);
            return r = "URLSearchParams" in window ? new URL(t) : r.toString(), new F(function(t, e) {
                if ("function" == typeof n) n(r, {
                    mode: "cors",
                    cache: "default"
                }).then(function(t) {
        ...
        try {
            if (window.FontAwesomeKitConfig) {
                ...
                (function() {
                    ...
                    }), L.detectingConflicts && T && U(function() {
                        T.setAttributeNode(document.createAttribute(L.detectionIgnoreAttr));
                        var t = function(t, e) {
                            var n = document.createElement("script");
